...
public class LocalAllignment extends AppCompatActivity {
    ...
    private TextView localAllignmentGraph;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_local_allignment);
        ...
        localAllignmentGraph = findViewById(R.id.textView);
    }

    public void localAllignment(View view)
    {
        ...
        localAllignmentGraph.setText(txt);
